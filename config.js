exports.creds = {
    // Required
    identityMetadata: 'https://login.microsoftonline.com/anitta13varghesegmail.onmicrosoft.com/v2.0/.well-known/openid-configuration', 
    ...
    redirectUrl: 'http://localhost:3000/auths/cb', 
